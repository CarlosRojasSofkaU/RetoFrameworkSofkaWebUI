...
public class Dictionary {
    ...
    public static final String MESSAGE_BY_DEFAULT_CUSTOMER = "My code is not working properly, I need help ASAP";
    public static final String SUBJECT_HEADING_BY_DEFAULT_COSTUMER = "Customer service";
