...
public class Helper {
    ...
    public static Customer generateCustomer(String language, String country, String emailDomain){
        ...
        customer.setContactUsMessage(MESSAGE_BY_DEFAULT_CUSTOMER);
        customer.setContactUsOrderReference(String.valueOf(faker.number().numberBetween(100000, 999999)));
        customer.setSubjectHeading(SUBJECT_HEADING_BY_DEFAULT_COSTUMER);
